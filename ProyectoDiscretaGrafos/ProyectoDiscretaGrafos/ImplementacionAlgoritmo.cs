...
namespace ProyectoDiscretaGrafos
{
    public class ImplementacionAlgoritmo
    {
        ...
        public void print(int destino)
        {
            ...
            {
                if(destino== Program.vertices[i].getId())
                {
                    text = Program.vertices[i].getNombre();
                }
                
            }
            MessageBox.Show("Id "+ destino+" Pais "+text);        //terminada la recursion imprimo los vertices recorridos
        }
